...
-- Mã gốc của bạn, với chức năng lụm trái cây và thông báo:
repeat
    wait()
...
for f, f in next, workspace:GetChildren() do
    if f.Name:find("Fruit") and (f:IsA("Tool") or f:IsA("Model")) then
        ...
        -- Thông báo "Đang đi lụm trái"
        game.StarterGui:SetCore(
            "SendNotification",
            {
                Title = "Turbo Lite",
                Text = "Đang Đi Nhặt Trái Cây",
                Duration = 10
            }
        )
...
-- Nếu không có trái cây, thông báo "Không có trái cây trong khu vực"
if not fruitsFound then
    game.StarterGui:SetCore(
        "SendNotification",
        {
            Title = "Turbo Lite",
            Text = "Không có trái cây trong khu vực",
            Duration = 5
        }
    )
end

-- Thông báo chuyển server (hiện một lần)
...
repeat
    task.spawn(
        ...
        function()
            ...
            -- Kiểm tra và thông báo chỉ một lần khi chuyển server
...
if not fruitsFound then
    game.StarterGui:SetCore(
        ...
        {
            Title = "Turbo Lite",
            Text = "Không Có Trái Cây Trong Server",
            Duration = 5
        }
    )
end

...
local CombatFrameworkLib = game:GetService("ReplicatedStorage"):FindFirstChild("CombatFramework")
local realbhit = CombatFrameworkLib and require(CombatFrameworkLib.RigLib)
if not realbhit then warn("RigLib không tồn tại trong CombatFramework!") end
...
local CombatFrameworkScript = game.Players.LocalPlayer.PlayerScripts:FindFirstChild("CombatFramework")
local CombatFramework = CombatFrameworkScript and require(CombatFrameworkScript)
if not CombatFramework then warn("CombatFramework không tồn tại trong PlayerScripts!") end


local CombatFrameworkR = CombatFramework and getupvalues(CombatFramework)[2]
if not CombatFrameworkR then warn("CombatFrameworkR không thể lấy được giá trị!") end
